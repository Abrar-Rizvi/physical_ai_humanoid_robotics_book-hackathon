...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://physical-ai-humanoid-robotics-book-lime.vercel.app", "https://physical-ai-humanoid-robotics-book-v4wt.onrender.com", "http://localhost:3000", "http://localhost:3001", "http://localhost:8080", "http://localhost:8000"],  # In production, replace with specific origins
